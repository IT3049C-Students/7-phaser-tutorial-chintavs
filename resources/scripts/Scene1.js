class Scene1 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet("power-up", "resources/spritesheets/power-up.png", {
            frameWidth: 16,
            frameHeight: 16
        });
        
        this.load.spritesheet("player", "resources/spritesheets/player.png", {
            frameWidth: 16,
            frameHeight: 24
        });

        this.load.spritesheet("beam", "resources/spritesheets/beam.png", {
            frameWidth: 16,
            frameHeight: 16
        });
